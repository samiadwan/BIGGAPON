            ...
            <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-md-10 col-xs-12">
                        ...
                        <form action="" id="adsPostForm" class="form-horizontal" enctype="multipart/form-data"
                            method="post"> @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8 {{ $errors->has('brand') ? 'has-error' : '' }}">
                                    ...
                                    <p class="text-info">@lang('app.skip_brand_text') <span id="brand_loader" style="display: none;"><i
                                ...
                                <div class="col-md-8">
                                    <label for="type_private" class="radio-inline">
                                        <input type="radio" value="personal" id="type_private" name="type"
                                            {{ old('type') == 'personal' ? 'checked="checked"' : '' }}>
                                        @lang('app.private')
                                    </label>
                                    <label for="type_business" class="radio-inline">
                                        <input type="radio" value="business" id="type_business" name="type"
                                            {{ old('type') == 'business' ? 'checked="checked"' : '' }}>
                            ...
                            <div class="form-group {{ $errors->has('video_url') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="video_url"
                                        ...
                                        placeholder="@lang('app.video_url')">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="price_input_group">
                                                    ...
                                                    <label><input type="radio" value="regular" name="price_plan"
                                                            data-price="{{ get_ads_price() }}" />@lang('app.regular')
                                                    </label> <br />
                                                    ...
                                                    <div class="addon-ad-charge">
                                                        <label><input type="checkbox" class="mark_ad_urgent"
                                                                name="mark_ad_urgent" value="1"
                                                                data-price="{{ get_option('urgent_ads_price') }}" />
                                                            @lang('app.mark_as_urgent') </label>
                                                    </div>
                                        ...
                                        <div class="form-group {{ $errors->has('payment_method') ? 'has-error' : '' }}">
                                            ...
                                            <div class="col-sm-8">
                                                <select class="form-control select2NoSearch" name="payment_method"
                                                    id="payment_method">
                                                    @if (get_option('enable_paypal') == 1)
                                                        <option value="paypal"
                                                            {{ old('payment_method') == 'paypal' ? 'selected' : '' }}>
                                                            @lang('app.paypal')</option>
                                                    @endif
                                                    @if (get_option('enable_stripe') == 1)
                                                        <option value="stripe"
                                                            {{ old('payment_method') == 'stripe' ? 'selected' : '' }}>
                                                            @lang('app.stripe')</option>
                                                    @endif
                                                </select>
