                    ...
                    <div class="modern-home-search-bar-wrap">
                        <div class="search-wrapper">
                            <form class="form-inline" action="{{ route('listing') }}" method="get">
                                ...
                                <button type="submit" class="btn theme-btn"> <i class="fa fa-search"></i> Search
                                    Ads</button>
                            </form>
                        </div>
                                        ...
                                        <div class="modern-cat-list-with-sub-wrap">
                                            <div class="modern-home-cat-top-item">
                                                <a href="{{ route('listing') }}?category={{ $category->id }}">
                                                    <i class="fa {{ $category->fa_icon }}"></i>
                                                    <span
                                                        class="category-name"><strong>{{ $category->category_name }}</strong>
                                                    </span>
                                                </a>
                                            </div>
                                                ...
                                                @if ($category->sub_categories->count())
                                                    <ul class="list-unstyled">
                                                        ...
                                                        @foreach ($category->sub_categories as $s_cat)
                                                            <li><a
                                                                    href="{{ route('listing') }}?category={{ $category->id }}&sub_category={{ $s_cat->id }}">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <hr />
                    <div class="ads_new_regular_ads_wrap ads-carousel-ads">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="ads_new_premium_ads_wrap ads-carousel-ads">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="home-latest-blog ads-carousel-blog-post">
                        @foreach ($posts as $post)
                            <div>
                                ...
                                <a class="btn btn-default"
                                    href="{{ route('blog_single', $post->slug) }}">@lang('app.continue_reading') <i
...
@section('page-js')
    ...
    <script>
        $(document).ready(function() {
            $(".ads_new_premium_ads_wrap").owlCarousel({
                loop: true,
                margin: 10,
        ...
        $(document).ready(function() {
            $(".ads_new_regular_ads_wrap").owlCarousel({
                loop: true,
                margin: 10,
                responsiveClass: true,
                responsive: {
