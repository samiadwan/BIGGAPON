            ...
            <div class="row">
                <div class="modern-single-ad-top-description">
                    ...
                    <div class="col-sm-5 col-xs-12">
                        ...
                        <h2 class="modern-single-ad-price">{{ ads_price_ng($ad->price) }}</h2>
                        ...
                        <p><strong><i class="fa fa-money"></i> @lang('app.price')</strong> {{ ads_price_ng($ad->price) }} </p>
                            ...
                            <div>
                                <div itemscope itemtype="http://schema.org/Product" class="ads-item-thumbnail ad-box-{{$rad->price_plan}}">
                                    ...
                                    <div class="caption">
                                        ...
                                        <p class="price"> <span itemprop="price" content="{{$rad->price}}"> {{ ads_price_ng($rad->price, $rad->is_negotiable) }} </span></p>
