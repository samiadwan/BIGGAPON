...
@if(config('app.is_demo'))
    ...
    <div class="ads-demo-chooser-wrap">
        <div class="ghuranti">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-footer"><a href="https://codecanyon.net/item/ads-classifieds-cms/18221399?ref=ads">Purchase it now just for <span class="btn btn-success"><i class="fa fa-cart-plus"></i> Buy it </span></a> </div>
        </div>


        <style type="text/css">
            /** Demo credential */
            .ads-demo-chooser-wrap{
                width: 300px;
                height: 300px;
                position: absolute;
                top: 30%;
...
<script>
    $(document).on('click', '.ghuranti', function(){
        $('.ads-demo-chooser-wrap').toggleClass('open');
    });
</script>
